          ...
          <div className="flex flex-col gap-[30px]">
           <Avatar />
            <div className="max-w-2xl flex flex-col gap-[30px]">
              ...
              <p>
                I’m Duyet Dinh, a software developer based in Da Nang City. I’m
                a key member of Driving theory app, where we develop
                technologies that empower regular people to users with a
                comprehensive and user-friendly platform to enhance their
                knowledge and skills in preparation for the theory test.
              </p>
              <div className="flex gap-6">
                <a href="https://twitter.com/DuyetDS" target="_blank">
                  <svg
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                ...
                <a href="https://www.instagram.com/oiduyet" target="_blank">
                  <svg
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                    className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300"
                ...
                <a href="https://github.com/DuyetQB" target="_blank">
                  <svg
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                    className="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300"
                ...
                <a
                  href="https://www.linkedin.com/in/dinh-duyet-127624197/"
                  target="_blank"
                >
                  <svg
                    viewBox="0 0 24 24"

                  ...
                  >
                    {/* <li className="group relative flex flex-col items-start">
                      ...
                      <h2 className="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                        ...
                        <a href="https://phimmoi-ten.vercel.app/"  target="_blank">
                          <span className="absolute -inset-x-4 -inset-y-6 z-20 sm:-inset-x-6 sm:rounded-2xl" />
                          <span className="relative z-10">PhimMoi</span>
                        </a>
                      </h2>
                      <p className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                        Creating technology to empower users to explore and enjoy
                        the movies anytime, anywhere. A flavoring for a refreshing spirit for movie lovers
                      </p>
                    ...
                    {/* <li className="group relative flex flex-col items-start">
                      ...
                      <h2 className="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                        <div className="absolute -inset-x-4 -inset-y-6 z-0 scale-95 bg-zinc-50 opacity-0 transition group-hover:scale-100 group-hover:opacity-100 sm:-inset-x-6 sm:rounded-2xl dark:bg-zinc-800/50" />
                        <a href="https://crowdwork.dps-fpt.vn/home" target="_blank">
                          <span className="absolute -inset-x-4 -inset-y-6 z-20 sm:-inset-x-6 sm:rounded-2xl" />
                          <span className="relative z-10">CrowdWork</span>
                        </a>
                      </h2>
                      <p className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
